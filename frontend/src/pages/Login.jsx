    ...
    <div className="min-h-screen bg-dark-900 flex">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <div key={stat.label} className="bg-dark-700/50 border border-dark-600 rounded-xl p-4">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <button onClick={handleGoogleLogin} className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-700 font-semibold py-3 px-4 rounded-xl transition-all mb-6 shadow-md">
