      ...
      <div className="w-full max-w-md">
        ...
        <div className="card">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-700 font-semibold py-3 px-4 rounded-xl transition-all mb-5 shadow"
          >
                    ...
                    {[1, 2, 3, 4, 5].map(i => (
                      <div
                        ...
                        className={`h-1 flex-1 rounded-full transition-all ${
                          i <= strength ? strengthColor : 'bg-dark-600'
                        }`}
                      />
                    ))}
                  </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                {formData.confirm && formData.password === formData.confirm && (
                  <CheckCircle className="absolute right-3 top-3.5 text-green-400" size={18} />
                )}
              </div>
              {errors.confirm && (
                <p className="text-red-400 text-xs mt-1 flex items-center gap-1">
